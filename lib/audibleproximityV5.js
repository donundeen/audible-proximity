...
class AudibleProximity {
  ...
  constructor(options) {
    ...
    waitForHeadphones(options, function () {
      ...
      dummy  = spawn('python', ['/home/pi/audible-proximity/lib/getbeacondata.py']);
 ...
 */
function handleRaddec(instance, id, raddec) {
...
//    audibleDevice.timestamp = raddec.timestamp;
    ...
    let file = id.padStart(7, "0")+".mp3";
     ...
     file = instance.audioFolderPath + "/" + file;
