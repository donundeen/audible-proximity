...
function handleRaddec(instance, raddec) {
  ...
  if (isKnownAudibleDevice) {
    console.log(sig + " KNOWN V " + targetVolume + " R " + rssi);
...
//      console.log("start process packets");
 ...
 //     console.log("end process packets");
    ...
    if (isAudible) {
         console.log(sig + " NEW V " + targetVolume + " R " + rssi);
...
//      console.log(concurrencyCount + " out of " + DEFAULT_MAX_CONCURRENT_PLAYERS);
    ...
    - update player volume
  */
      console.log("volume " + player.file  + "  : " + player.volume);
  ...
  */
      if(audibleDevice.isPlaying || audibleDevice.isFading){
        ...
        console.log("fading "  + player.file + " : " +  player.volume);
