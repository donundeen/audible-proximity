...
*/
    ...
    */
    ...
    audibleDevice.elapsedTime = raddec.timestamp - audibleDevice.timestamp;
...
function showDebugScreen(audibleDevices){
  ...
  closestAudibleDevices.forEach(function (audibleDevice) {
    let player = audibleDevice.player;
    console.log(audibleDevice.file + " : " + (audibleDevice.isPlaying ? "P" : "") + (audibleDevice.isFading ? "F" : "") + " : " + player.volume + " : " + audibleDevice.rssi + " : " + audibleDevice.elapsedTime);    
  });
}
